        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Automotive</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Banking</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Energy & Utilities</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Digital</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Enterprise Agile</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Cloud</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">AI & Analytics</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Product Engineering</a></li>
            </ul>
          </div>
